...
public class Excel {
	...
	try{
		...
		//to set cell type explicitely to String so that it can treat even integers as string values and fetch them from cells
		wb.getSheet(sheet).getRow(row).getCell(cell).setCellType(Cell.CELL_TYPE_STRING);

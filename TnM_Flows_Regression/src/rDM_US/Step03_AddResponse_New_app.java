...
public class Step03_AddResponse_New_app
{
	...
	// Define the element 
		...
		@FindBy ( xpath="//span[contains(text(),'Secondary Skills Requested')]") private WebElement Secondary_Skills_Panel ;
		@FindBy (xpath= "//label[contains(text(),' Apply Knowledge of Security in Unix & Linux Envirs ')]//ancestor::div[@class='bx--col-md-3 ']//following-sibling::div[2]/ibm-dropdown/div/button") private WebElement Apply_Knowledge_of_Security_in_Unix_Linux_Envirs;
		@FindBy (xpath= "//label[contains(text(),' Apply Knowledge of Security in Unix & Linux Envirs ')]//ancestor::div[@class='bx--col-md-3 ']//following-sibling::div[2]/ibm-dropdown/div/div/ibm-dropdown-list/ul/li[1]/div") private WebElement Apply_Knowledge_of_Security_in_Unix_Linux_Envirs_value;
		@FindBy (xpath= "//label[contains(text(),' Use AIX Debug Tools ')]//ancestor::div[@class='bx--col-md-3 ']//following-sibling::div[2]/ibm-dropdown/div/button") private WebElement Use_AIX_Debug_Tools;
		@FindBy (xpath= "//label[contains(text(),' Use AIX Debug Tools ')]//ancestor::div[@class='bx--col-md-3 ']//following-sibling::div[2]/ibm-dropdown/div/div/ibm-dropdown-list/ul/li[2]/div") private WebElement Use_AIX_Debug_Tools_value;
	...
	public void FillRespdetails(String First_Name_temp , String Middle_Name_temp , String LastName_Surname_temp, String citizenship , String rate, String overtime ) throws IOException, InterruptedException 
	{
		...
		executor.executeScript("arguments[0].click();", Secondary_Skills_Panel);
		executor.executeScript("arguments[0].click();", Apply_Knowledge_of_Security_in_Unix_Linux_Envirs);
		Thread.sleep(1000);
		executor.executeScript("arguments[0].click();", Apply_Knowledge_of_Security_in_Unix_Linux_Envirs_value);
		executor.executeScript("arguments[0].click();", Use_AIX_Debug_Tools);
		Thread.sleep(1000);
		executor.executeScript("arguments[0].click();", Use_AIX_Debug_Tools_value);
		/*Taking screenshot */

...
public class Step01_CreateRequest_US {
	...
	@FindBy (id ="FLD_REQ_TYPE2") private WebElement REFERRAL ;
	...
	//Candidate name 
	@FindBy ( id="FLD_CAND_FIRST_NM") private WebElement Can_First_Name;
	@FindBy ( id="FLD_CAND_LAST_NM") private WebElement Can_Last_Name;
	@FindBy ( id="FLD_CAND_DOB") private WebElement Can_DOB;
	...
	public void Create_Referral_Request()
	{
		WebDriverWait wait01 = new WebDriverWait(driver, 180);
	...
	public void Skill_Request(){
		...
		wait02.until(ExpectedConditions.visibilityOf(REFERRAL));
	...
	public void Candidate_Details()
	{

		WebDriverWait wait1 = new WebDriverWait(driver, 160);
		wait1.until(ExpectedConditions.visibilityOf(Can_First_Name));

		Can_First_Name.clear();
		isAlertPresent();
		Can_First_Name.sendKeys("CandFname");
		Can_Last_Name.clear();
		isAlertPresent();
		Can_Last_Name.sendKeys("CandLname");
		Can_DOB.clear();
		isAlertPresent();
		Can_DOB.sendKeys("05/24");

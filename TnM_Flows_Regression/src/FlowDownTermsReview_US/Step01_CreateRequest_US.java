...
public class Step01_CreateRequest_US {
	...
	public void login() throws InterruptedException
	{
		...
		try {
			...
			System.out.println("entered passcode and clicked on Submit passcode buton");
	...
	public void Request_detailpage(String ProjectName){
		...
		FFIEC.click();
		NREG.click();
		Accounting_Type_Internal.click();
	...
	public void Skill_detailLocationpage(String FlowDownValue)
	{
		...
		//Selecting Flowdown field value
		if(FlowDown_Checkbox.isSelected())
		{
			if(FlowDownValue=="Yes")
			{Flowdown_YesRadio.click();		
			}
			else if(FlowDownValue=="No")
		...
		else if(!FlowDown_Checkbox.isSelected())
		{
			...
			wait13.until(ExpectedConditions.visibilityOf( Flowdown_YesRadio));
			if(FlowDownValue=="Yes")
			{Flowdown_YesRadio.click();		
			}
			else if(FlowDownValue=="No")
	...
	public String SupplierSelectionPage() throws InterruptedException
	{
		...
		shot5.ScreenShot_FlowDownReview_US();

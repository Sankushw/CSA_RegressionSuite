...
public class Step02_AddResponse_US_NewApp
{
	...
	@FindBy (xpath= "//div[@class='bx--list-box__menu-item__option' and contains(text(),'Any pricing level')]") private WebElement Skill_Level_Value;
	...
	@FindBy ( xpath="//clapp-skill-response-detail[@class='ng-star-inserted']/div[3]/button[2]") private WebElement Reprice_Button ;

...
import lib.Excel;
import nonPriced_US.Step01_CreateRequest;
...
public class CI_NonPriced_CreateReq_AddResp_Test
{
	// TestNG logger
	...
	public void setup() throws ClassNotFoundException, SQLException
	{
      ...
      //  ((RemoteWebDriver) driver).setLogLevel(Level.INFO);
		...
		System.out.println("Starting execution of NonPriced flow");
	}	
	...
	public void T15_Submitresponse() throws InterruptedException
	{
		Step02_AddResponse_US_NewApp addresp = new Step02_AddResponse_US_NewApp(driver); 
		addresp.Submit();
	}
